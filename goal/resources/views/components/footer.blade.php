...
<!-- section seven -->
<section class="container hm_section_seven" style="display:none;">
...
<div class="ft_tp_line container-fluid p-0 pb-5" style="display:none;">
        <div class="row p-0 m-0">
    ...
    <!-- footer -->
    <section class="container-fluid footer mt-5 pb-5" style="display:none;">
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <!--  -->
    ...
    <section class="ft" style="display:none;">
